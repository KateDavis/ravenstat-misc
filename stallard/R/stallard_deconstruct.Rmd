...
print(projectp)
    g<-ggplot(projectdf,aes(exp.year,claims))+geom_bar(stat="identity")+facet_grid(.~injury)
    g<-ggplot(projectp,aes(exp.year,claims.cum.proj))+geom_bar(stat="identity")+facet_grid(.~injury)
   # print(g)
   # xdf=rbind(xdf,tdf)
  #}
```
